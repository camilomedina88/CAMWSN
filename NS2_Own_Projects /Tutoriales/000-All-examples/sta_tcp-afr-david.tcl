...
# Define options
# ======================================================================
source sta_tcp-default_options.tcl
...
#    $ns_ flush-trace
    ...
    set f_throughput [open "sta_tcp_afr_throughput.txt" "a"]
    set f_a_delay [open "sta_tcp_afr_average_delay.txt" "a"]
    set f_p_delay [open "sta_tcp_afr_peak_delay.txt" "a"]
    set f_fairness [open "sta_tcp_afr_fairness.txt" "a"]
