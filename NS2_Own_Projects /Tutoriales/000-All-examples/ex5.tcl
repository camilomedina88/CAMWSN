...
# example 5:
#
# Demonstrates the use of overlays.  You can overlay the plotdata from
# one or more graphs onto another.  In this example we show two TCP
# connections cwnd versus time in a single plot.
#
...
proc finish {} {
  global cwnd0_graph cwnd1_graph
