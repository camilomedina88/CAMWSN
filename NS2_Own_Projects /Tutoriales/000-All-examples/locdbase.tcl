# locdbase.tcl -- TCL-world location database object

# Brad Karp, July, 1999

# XXXXX I don't think this is necessary. Not including it in ns-lib.tcl for
# now. -karp

# the below are cribbed from timer.tcl, to mimic -karp
...
LocDbase instproc register {addr mnode} {
    global ns
