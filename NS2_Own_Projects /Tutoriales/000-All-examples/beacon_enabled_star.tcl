...
if { "$val(traffic)" == "ftp" } {
   ...
   $ns_ at $appTime(1) "Mac/802_15_4 wpanNam PlaybackRate 0.20ms"
   $ns_ at [expr $appTime(1) + 0.5] "Mac/802_15_4 wpanNam PlaybackRate 1.5ms"
   ftptraffic 0 1 $appTime(1)
   $ns_ at $appTime(1) "$ns_ trace-annotate \"(at $appTime(1)) ftp traffic from node 0 to node 1\""
   Mac/802_15_4 wpanNam FlowClr -p AODV -c tomato
   Mac/802_15_4 wpanNam FlowClr -p ARP -c green
   Mac/802_15_4 wpanNam FlowClr -p MAC -s 0 -d -1 -c navy
