...
Mac/802_16 set throughput_delay_     0.01
Mac/802_16 set algoritmo_ared_ 1 ;# define se utilizará algoritmo ARED para gerenciamento de filas (0 => NÃO, 1 => SIM)
#Mac/802_16 set maximum_delay_ 0.15 ;# delay ou latência máxima p/ aplicação => 150 ms
Mac/802_16 set maximum_delay_ 9999 ;# delay ou latência máxima p/ aplicação => 9999 s
#Mac/802_16 set tolerated_jitter_ 0.05 ;# jitter máximo tolerado => 50 ms
#Mac/802_16 set tolerated_jitter_ 0.1 ;# jitter máximo tolerado => 100 ms
Mac/802_16 set tolerated_jitter_ 9999 ;# jitter máximo tolerado => 9999 s
...
#$ss_sched add-flow 2 0 1600 $i
  ...
  set vbr_($i) [new Application/Traffic/Exponential]
  $vbr_($i) set packetSize_ 512
  $vbr_($i) set burst_time_ 500ms
  $vbr_($i) set idle_time_ 500ms
  $vbr_($i) set rate_ 1Mb
  #set rtps_($i) [new Application/Traffic/rtPS]
  #$rtps_($i) attach-agent $udp_($i)
  #$vbr_($i) set maxrate_ 384Kb;
