...
$sipA set Mode_ 1  ;# if mode_ set 1, means Mobility Support, currently not used 
...
set sipC [new Agent/SIPProxy www.nist.gov]
$sipC set packetSize_ 1000
$sipC set print_ 0
$ns attach-agent $n3 $sipC

set sipD [new Agent/SIPProxy www.antd.gov]
