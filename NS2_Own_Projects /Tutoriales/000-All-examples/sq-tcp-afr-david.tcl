...
# Define options
# ======================================================================
source sq-tcp-default_options.tcl

# variables always changed
#------------------------------------------------------------------------
set val(nn)		        2
set val(Sq_LIMIT)       [lindex $argv 5]
set val(run)            50.0
...
#    $ns_ flush-trace
    ...
    set f_throughput [open "sq_tcp_afr_throughput.txt" "a"]
    set f_a_delay [open "sq_tcp_afr_average_delay.txt" "a"]
    set f_p_delay [open "sq_tcp_afr_peak_delay.txt" "a"]
    set f_fairness [open "sq_tcp_afr_fairness.txt" "a"]
