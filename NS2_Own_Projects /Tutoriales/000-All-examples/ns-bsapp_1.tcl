...
#     puts "rozhodovanie_bs nodeID $nodeID a sender $sender a currentCH preneseny je $currentCH_"
#     puts "rozhodovanie_bs nodeID $nodeID a sender $sender "
    if {$msg_type == $INFO} {
...
Application/BSApp instproc recvINFO {sender msg} {
  ...
  set E [lindex $msg 2]
  incr total_
  puts "BS received info: ($X $Y $E) from Node $sender  a nodik je $nodik - mit/uAMPS/ns-bsapp.tcl" 
