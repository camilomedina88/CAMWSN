...
# Define options
# ======================================================================
source sta-default_options.tcl
...
Mac/802_11      set AverageFrameSize_ 0
...
#    $ns_ flush-trace
    ...
    set f_throughput [open "sta-afr_throughput.txt" "a"]
    set f_a_delay [open "sta-afr_average_delay.txt" "a"]
    set f_p_delay [open "sta-afr_peak_delay.txt" "a"]
    set f_fairness [open "sta-afr_fairness.txt" "a"]
