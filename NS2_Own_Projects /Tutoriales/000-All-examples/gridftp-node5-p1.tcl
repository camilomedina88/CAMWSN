...
# Open the trace file
set nd [open node5-p1.tr w]


set bandwith21  50.264
set bandwith31  46.423
set bandwith41  [expr 563.357/1024 ]
set bandwith51  [expr 557.980/1024 ]
...
$ns duplex-link $node1 $node3 [expr $bandwith31]Mb 2ms DropTail
$ns duplex-link $node1 $node4 [expr $bandwith41]Mb 2ms DropTail
$ns duplex-link $node1 $node5 [expr $bandwith51]Mb 2ms DropTail
