# http://www.linuxquestions.org/questions/linux-newbie-8/ns2-installation-on-ubuntu-with-olsr-patch-giving-following-error-4175418287/#11

set escenario [lindex $argv 0]

set opt(chan) Chanel/WirelessChanel
