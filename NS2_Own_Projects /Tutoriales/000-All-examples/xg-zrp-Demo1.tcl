...
#
# Demo1.tcl edited 17-Nov-2012 >>> zrp-Demo1.tcl , @knudfl
...
set agent1 [new Agent/CBR]             ;# Create UDP Agent
...
set agent2 [new Agent/CBR]             ;# Create UDP Agent
...
set agent4 [new Agent/CBR]             ;# Create UDP Agent
