...
lappend cluster_num 1 1 1 1 1 1 1            			;# cluster number for each domain
AddrParams set cluster_num_ $cluster_num
lappend eilastlevel 1 1 1 1 1 1 [expr ($nb_mn+$nb_rs+1)] 		;# number of nodes for each cluster
