#
# A wireless lan scenario with VBR and CBR video traffics and audio traffic over udp
#
#

set num_nodes          7	     ;#Number of nodes in the scenario
...
TSPEC set DataRate_4 [expr $pktvideoCBR * 8 *1000 / $periodCBR]
...
#VBR H.261 video traffic
	...
	$ns_ attach-agent $node_($i) $V_src([expr 10 + $i])
...
#CBR MPEG4 traffic
	...
	$ns_ attach-agent $node_($i) $V_src([expr 20 + $i])
    ...
    set title_ "set title \"VBR, CBR video and audio flows in each node\""
}
