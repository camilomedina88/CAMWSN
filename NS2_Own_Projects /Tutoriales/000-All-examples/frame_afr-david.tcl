...
# Define options
# ======================================================================
source frame_default_options.tcl

#-------------------------------------------------------------------------------- 
set val(nn)             10
set val(ifqlen)         100                          ;# max packet in ifq
set val(Sq_LIMIT)       200
set val(run)            10.0
...
#    $ns_ flush-trace
    ...
    set f_throughput [open "frame_afr_throughput.txt" "a"]
    set f_a_delay [open "frame_afr_average_delay.txt" "a"]
    set f_p_delay [open "frame_afr_peak_delay.txt" "a"]
    set f_fairness [open "frame_afr_fairness.txt" "a"]
	...
	for {set i 0} {$i < $val(nn) } {incr i} {
        ...
        set recvFrameNUM      [$mac set recvFrameNUM_]
...
#	puts "The total Delay=$totalDelay"
    ...
    puts "The recvFrameNUM      = $recvFrameNUM"
    puts "The throughput 1      = [expr $recvFrameNUM * $AverageFrameSize]"
