...
# Define options
# ======================================================================
source model-default_options.tcl
...
#    $ns_ flush-trace
    ...
    set f_throughput [open "model-afr_throughput.txt" "a"]
    set f_a_delay [open "model-afr_average_delay.txt" "a"]
    set f_p_delay [open "model-afr_peak_delay.txt" "a"]
    set f_fairness [open "model-afr_fairness.txt" "a"]
