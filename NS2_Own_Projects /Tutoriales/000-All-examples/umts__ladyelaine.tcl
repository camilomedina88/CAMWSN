#    http://www.linuxquestions.org/questions/ubuntu-63/ns2-eurane-problem-classfier-no-slot%7B%7D-default-handler-4175539661/
...
set f [open umts1l.tr w]
$ns trace-all $f
set namfile [open umts1l.nam w]
