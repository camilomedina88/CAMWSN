...
set opt(ragent)		Agent/rtProto/WLSTATIC
set opt(pos)		NONE

if { $opt(pos) != "NONE" } {
	puts "*** WARNING: WLSTATIC using $opt(pos) position configuration..."
}
...
Agent/rtProto/WLSTATIC instproc init args {
        $self next $args
}       

Agent/rtProto/WLSTATIC set sport_	0
Agent/rtProto/WLSTATIC set dport_	0
