...
proc sens_gather_stats {args} {
    ...
    global ns_ opt node_ totalDATA
    global sens_energyf sens_dataf sens_alivef sens_statf
    ...
    for {set id 0} {$id < [expr $opt(nn)-1]} {incr id} {
      puts $sens_dataf "$thetime $id $totalDATA($id)"
    ...
    puts $sens_statf "$thetime\tTotal_Energy\t$total_energy\
                      \tTotal_Data\t$total_data\tTotal_Alive\t$total_alive"
