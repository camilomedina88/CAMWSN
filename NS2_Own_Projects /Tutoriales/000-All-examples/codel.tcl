...
# Modified by Dipesh Raghuvanshi, NITK Surathkal to modify CoDel patch for ns-2.31 - Start
# ns-2.35 has all the versions of TCP including Linux which does not exist in ns-2.31
# Hence, TCP-Linux is removed to work this script for ns-2.31
...
# Modified by Dipesh Raghuvanshi, NITK Surathkal to modify CoDel patch for ns-2.31 - End
...
proc build_ftpclient {cnd snd startTime timeToStop Flow_id} {
    ...
    # Modified by Dipesh Raghuvanshi, NITK Surathkal to modify CoDel patch for ns-2.31 - Start
    # ns-2.35 has all the versions of TCP including Linux which does not exist in ns-2.31
    # Hence, TCP-Linux is replaced by TCP-SACK
    set ctcp [$ns create-connection TCP/Sack1 $snd TCPSink/Sack1 $cnd $Flow_id]
    # Modified by Dipesh Raghuvanshi, NITK Surathkal to modify CoDel patch for ns-2.31 - End
