...
# scenario with a single TCP NewReno flow.
...
$ns_ use-newtrace
set tracefd     [open newreno_10hop_chain.tr w]
set namtrace    [open newreno_10hop_chain.nam w]
set gptrace     [open newreno_10hop_chain.gp w]
...
set tcp_(2) [new Agent/TCPSink/copeTcpSink]
