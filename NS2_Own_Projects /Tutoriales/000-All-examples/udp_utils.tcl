...
#---------------------------------------------------------
Application/Traffic/SipUdp instproc start_call_ {num from to} {
    global ns call_time voice n_voice_ udp null_ voice_packet_size voice_burst_time voice_idle_time voice_rate expoo
...
Application/Traffic/SipUdp instproc stop_call_ {num from to} {
