...
Mac/LWX env BWA_Scheduler_Algo_Type     101
...
$ns attach-agent  $node(0)  $udp_(2)
set null_(2)  [new Agent/Null]
$ns attach-agent  $node(2)  $null_(2)

# cbr
set cbr_(2) [new Application/Traffic/CBR]
$cbr_(2) set packetSize_ 200
$cbr_(2) set rate_       4000000
...
# ss->bs
# init env var
set flow_info     [$udp_(2) flow_info]
set src_nid       $node_id(0)
set from_nid      $node_id(0)
set to_nid        $node_id(2)
...
$ns at 0.50 "$cbr_(2) start"
$ns at 3.00 "$cbr_(2) stop"
...
$ns attach-agent  $node(0)  $udp_(3)
set null_(3)  [new Agent/Null]
$ns attach-agent  $node(2)  $null_(3)

# cbr
set cbr_(3) [new Application/Traffic/CBR]
$cbr_(3) set packetSize_ 200
$cbr_(3) set rate_       4000000
...
# ss->bs
# init env var
set flow_info     [$udp_(3) flow_info]
set src_nid       $node_id(0)
set from_nid      $node_id(0)
set to_nid        $node_id(2)
...
# 1. Auto Set (Randomly Set each Subch.'s MCR according to <MCR1>/<MCR2>/<MCR3>/...
# Mac/LWX env set_relay <type> $src_nid $flow_info $rs_nid MCR_Subch Auto <MCR1>/<MCR2>/<MCR3>/...
# 2. Customize
# Mac/LWX env set_relay <type> $src_nid $flow_info $rs_nid MCR_Subch <Subch Num> <MCR>

Mac/LWX env set_relay bs_to_rs $src_nid $flow_info $node_id(1) MCR_Subch Auto 100/110/120

# adding relay link from rs to ss
# relay link 2
...
Mac/LWX env set_flow $src_nid $node_id(1) $to_nid $flow_info Rmax       5000000
...
Mac/LWX env set_flow $src_nid $node_id(1) $to_nid $flow_info MCR_Subch Auto 20/40/60/80/70/50/30

$ns at 0.50 "$cbr_(3) start"
$ns at 3.00 "$cbr_(3) stop"
...
$ns attach-agent  $node(0)  $udp_(4)
set null_(4)  [new Agent/Null]
$ns attach-agent  $node(2)  $null_(4)

# cbr
set cbr_(4) [new Application/Traffic/CBR]
$cbr_(4) set packetSize_ 200
$cbr_(4) set rate_       4000000
...
# ss->bs
# init env var
set flow_info     [$udp_(4) flow_info]
set src_nid       $node_id(0)
set from_nid      $node_id(0)
set to_nid        $node_id(2)
...
$ns at 0.50 "$cbr_(4) start"
$ns at 3.00 "$cbr_(4) stop"
...
Mac/LWX env set_relay ss_to_rs_tp $src_nid $flow_info $node_id(3) MCR_Subch Auto 100/110/120
...
Mac/LWX env set_flow $src_nid $node_id(3) $to_nid $flow_info MCR_Subch Auto 20/40/60/80/70/50/30
