...
exec xgraph alivenodes_leach.tr  -geometry 800x400 -t "alivenodes vs time" -x "time" -y "alivenodes" -bg white -P &
exec xgraph frames_leach.tr -geometry 800x400 -t "frames vs round number" -x "rounds" -y "frames" -bg white -P &
exec xgraph bitsfromcluster_leach.tr -geometry 800x400 -t "bits from cluster vs time" -x "time" -y "bits from cluster" -bg white -P &       
