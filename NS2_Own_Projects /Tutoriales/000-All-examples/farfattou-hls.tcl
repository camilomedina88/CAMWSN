...
set val(mactrc)         OFF ;# Trace MAC Layer
set val(movtrc)         OFF ;# Trace Movement


set val(lt)		""
set val(cp)		"/home/fatma/ns-allinone-2.33/bin/cbr"
set val(sc)		"/home/fatma/ns-allinone-2.33/bin/2"

set val(out)            "/home/fatma/ns-allinone-2.33/bin/gpsr20_2.t"
