...
set f14 [open data22.tr w]
set f15 [open data32.tr w]
...
$app1 set packetSize_ 1400               ;# Set Packet Size to 512 bytes
#$app1 set rate_ 6000Kb                    ;# Set CBR rate to 200 Kbits/sec
$app1 set interval_ 0.0005		;##### frange( 0.001, 0.05, 0.0005 ) 
...
$app2 set packetSize_ 1400               ;# Set Packet Size to 512 bytes
#$app2 set rate_ 6000Kb                    ;# Set CBR rate to 200 Kbits/sec
$app2 set interval_ 0.0005		;##### frange( 0.001, 0.05, 0.0005 ) 
