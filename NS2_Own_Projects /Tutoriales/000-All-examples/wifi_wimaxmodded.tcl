...
#                                   /
#                                  /
# router0(0.0.0)---router1(1.0.0)------------bstation802.11(5.0.0)->)                             +------------------------------------+
#                                  \                                                              + iface1:802.11(2.0.1)|              |
#                                   \                                                             +---------------------+ MutiFaceNode |
...
set output_dir .
set traffic_start 0
set traffic_stop  280
set simulation_stop 280
...
# configure Base station 802.11
set bstation802a [$ns node 5.0.0] ;
$bstation802a set X_ 600.0
$bstation802a set Y_ 1000.0
$bstation802a set Z_ 0.0
puts "bstation802a: tcl=$bstation802a; id=[$bstation802a id]; addr=[$bstation802a node-addr]"
# we need to set the BSS for the base station
set bstationMac1 [$bstation802a getMac 0]
set AP_ADDR_1 [$bstationMac1 id]
puts "bss_id for bstation 2=$AP_ADDR_1"
$bstationMac1 bss_id $AP_ADDR_1
$bstationMac1 enable-beacon
...
# configure Base station 802.11
set bstation802b [$ns node 6.0.0] ;
$bstation802b set X_ 700.0
$bstation802b set Y_ 1000.0
$bstation802b set Z_ 0.0
puts "bstation802b: tcl=$bstation802b; id=[$bstation802b id]; addr=[$bstation802b node-addr]"
# we need to set the BSS for the base station
set bstationMac2 [$bstation802b getMac 0]
set AP_ADDR_2 [$bstationMac2 id]
puts "bss_id for bstation 3=$AP_ADDR_2"
$bstationMac2 bss_id $AP_ADDR_2
$bstationMac2 enable-beacon
...
$ns at $departure "$iface1 setdest 1000.0 1000.0 15.0"
$ns at $departure "$iface1 setdest 540.0 1000.0 15.0"
...
# define node movement. We start from outside the coverage, cross it and leave.
$ns at $departure "$iface2 setdest 1000.0 1000.0 15.0"
$ns at $departure "$iface1 setdest 540.0 1000.0 15.0"
