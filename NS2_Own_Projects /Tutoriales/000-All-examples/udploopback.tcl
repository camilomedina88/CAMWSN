...
$ns_ at 0.0 "$p2 attach-agentj agentj.examples.udp.Server"
$ns_ at 0.0 "$p1 attach-agentj agentj.examples.udp.Client"
...
$ns_ at 1.0 "$p1 agentj send hello [$n1 node-addr]"
