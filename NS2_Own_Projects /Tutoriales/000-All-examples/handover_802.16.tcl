...
proc finish {} {
        global ns tf output_dir nb_mn gf
        $ns flush-trace
        close $tf
	close $gf
	 #Call xgraph to display the results
	exec nam wire3-out.nam &
        exec xgraph ograph.tr -geometry 800x400 &
        exit 0
}
...
set gf [open $output_dir/ograph.tr w]

set namtrace [open wire3-out.nam w]
...
#[$wl_node set mac_(0)] 1 ;# setting up static flows 
...
proc record {} {
	...
	#Get an instance of the simulator
        ...
        puts $gf "$now [expr $bw0/$time*8/1000000]"
