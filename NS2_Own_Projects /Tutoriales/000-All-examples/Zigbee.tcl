...
#     http://read.pudn.com/downloads132/sourcecode/unix_linux/network/562430/code/zigbee.tcl__.htm

# ======================================================================
# Default Script Options
# ======================================================================

set opt(ragent)		Agent/rtProto/ZIGBEE
set opt(pos)		NONE

if { $opt(pos) != "NONE" } {
	puts "*** WARNING: ZIGBEE using $opt(pos) position configuration..."
}
...
Agent/rtProto/ZIGBEE instproc init args {
        $self next $args
}       

Agent/rtProto/ZIGBEE set sport_	0
Agent/rtProto/ZIGBEE set dport_	0
