...
if {$argc != 8} {
    puts "usage: ns xxx.tcl numflows link_rate(Gbps) RTT(per hop,sec) load numbneck init_nr_flows minPkts maxPkts"
    exit 0
}
...
puts "Arrival: Poisson with lambda $lambda, FlowSize: Uniform with avg minPkts $minPkts maxPkts $maxPkts $mean_npkts pkts"
