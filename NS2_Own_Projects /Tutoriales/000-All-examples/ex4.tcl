...
# example 4:
#
# Demonstrates outputing files to multiple plot devices.
#
...
# If gnuplot and xgraph are not installed on your computer then this example
# will not work. We do not define a default plot device. See finish.
# We define two plot devices at the time we plot the graph. 
