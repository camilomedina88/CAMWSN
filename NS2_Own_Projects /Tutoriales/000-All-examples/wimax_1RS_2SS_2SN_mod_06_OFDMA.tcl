...
Mac/802_16 set queue_measure_ 1
...
# Open file for trace
set tf [open $output_dir/wimax_1RS_2SS_2SN_mod_06_OFDMA.tr w]
$ns trace-all $tf
#puts "Output file configured"

# Open file for recording throughput
set throughput_rv_ [open $output_dir/throughput_mod_06_OFDMA.tr w]
...
#  }
  ...
  #$cbr_($i) set rate_ [expr 500*8]
  #$cbr_($i) set rate_ 5000
