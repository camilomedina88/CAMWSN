...
proc main { } {
   ...
   source ./tcl/lib/proc-tools.tcl
   source ./tcl/lib/proc-topo.tcl
   source ./tcl/lib/ns-topoman.tcl
   source ./tcl/lib/proc-mobi-global.tcl
   source ./tcl/lib/proc-mobi-config.tcl
