# http://sertel.upc.es/~maguilar/ns2_code_victor/ns2tutorial/node3.html
# Multipath simulations with MM-DSR and 802.11e
...
# Invalidated parameter when using DSR!
set opt(ifqlen)         50 ;# max packet in ifq, it is the MAC queue size
# To modify it, change IFQLEN in dsr-priqueue.h!
...
set opt(X)	        520  ;# X & Y dimension of the topography
set opt(Y)	        520
...
Mac/802_11e set dataRate_          11.0e6            ;# 11Mbps
Mac/802_11e set basicRate_         11.0e6            ;# (1Mbps)
Mac/802_11e set bandwidth_         11.0e6            ;# (1Mbps)
