...
Mac/802_16 set weighted_factor_      0.002
...
#Mac/802_16 set fbandwidth_           10e+6 ;# EINAR
...
for {set i 0} {$i < $nb_rs} {incr i} {
  ...
  [$rstation_($i) set mac_(0)] set-channel [expr $i + 2]   ;# RS uses this channel to communicate with MSs
  [$rstation_($i) set mac_(0)] set-relay-channel 1   ;# RS uses this channel to communicate with BS
