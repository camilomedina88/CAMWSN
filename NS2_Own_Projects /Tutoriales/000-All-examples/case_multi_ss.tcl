...
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Rmax       2000000
...
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info QoS_Class  2
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Rmin       1000000
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Rmax       1900000
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Lmax       60
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Jitter     45
...
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info QoS_Class  2
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Rmin       1000000
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Rmax       1400000
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Lmax       60
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Jitter     45
...
$ns attach-agent  $node(1)  $udp_(2)
set null_(2)  [new Agent/Null]
$ns attach-agent  $node(0)  $null_(2)

# cbr
set cbr_(2) [new Application/Traffic/CBR]
$cbr_(2) set packetSize_ 200
$cbr_(2) set rate_       3000000
...
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info rate       12
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info QoS_Class  2
Mac/LWX env set_flow $src_nid $from_nid $to_nid $flow_info Rmin       1000000
...
#########################################
# TCP connections from node(2) to node(0)
######################################### 

# tcp
set tcp_(2) [new Agent/TCP]
$ns attach-agent $node(2) $tcp_(2)
set sink_(2) [new Agent/TCPSink]
$ns attach-agent $node(0) $sink_(2)
$ns connect $tcp_(2) $sink_(2)
$tcp_(2) set fid_ 2
#$tcp_(2) set packetSize_ 200

# ftp
set ftp_(2) [new Application/FTP]
$ftp_(2) attach-agent $tcp_(2)
$ftp_(2) set type_ FTP


# wimax for tcp data
# bs->ss
# init env var
set flow_info     [$tcp_(2) flow_info]
set src_nid       $node_id(2)
set from_nid      $node_id(2)
set to_nid        $node_id(0)
...
# ss->bs
# init env var
set flow_info     [$sink_(2) flow_info]
set src_nid       $node_id(0)
set from_nid      $node_id(0)
set to_nid        $node_id(2)
...
$ns at 3.00 "$ftp_(2) start"
$ns at 5.00 "$ftp_(2) stop"
...
puts [$udp_(2) flow_info]
puts [$tcp_(0) flow_info]
puts [$tcp_(1) flow_info]
puts [$tcp_(2) flow_info]
puts ==========
