############################################################################
# ZCJ DHAC with RSS information (2007)
...
Class Application/DHAC-RSS -superclass Application

############################################################################
# Start/End: DHAC-RSS algorithm Application
############################################################################
Application/DHAC-RSS instproc init args {
...
#===========================================================================
##### trigger the DHAC-RSS algorithm
Application/DHAC-RSS instproc start {} {
...
Application/DHAC-RSS instproc setupRESEMBLANCETABLE {} {
...
Application/DHAC-RSS instproc exchangeHELLOMESSAGE {} {
  global chan ns_ opt
...
Application/DHAC-RSS instproc sendHELLO {distance} {
...
Application/DHAC-RSS instproc recvHELLO {sender} {
...
Application/DHAC-RSS instproc TABLEPRINTING {} {
  global chan ns_ opt
...
############################################################################
# * 2 * SETUP PHASE: DHAC-RSS Clustering phase
############################################################################
##### The main function of executing the DHAC-RSS algorithm
Application/DHAC-RSS instproc executeDHAC {} {
  ...
  ##SETUP PHASE (2-1): execute DHAC-RSS algorithm
...
############################################################################
# * 3 * SETUP PHASE: execute DHAC-RSS algorithm
############################################################################
#===========================================================================
###### SEARCH the neighbor with SMALLEST COEFFICIENT and send INVITE message
Application/DHAC-RSS instproc InvitePartner {} {
  global chan ns_ opt node_
  ...
  if {$closest_id_ != -2 && $nodeID < $closest_id_} {  
     #Calculate the distance between two nodes
     set distance [expr $closest_dis_ * 2]
...
Application/DHAC-RSS instproc sendINVITE {distance} {
  global chan ns_ opt node_
...
Application/DHAC-RSS instproc recvINVITE {msg sender} {
...
Application/DHAC-RSS instproc ComfirmInvitation {isCorresponding INVITEreceiver INVITEsender} {
...
Application/DHAC-RSS instproc sendCONFIRM {INVITEsender mergePart1 mergePart2 distance} {
  global chan ns_ opt node_
...
Application/DHAC-RSS instproc recvPOSITIVECONFIRM {msg} {
  global ns_ opt
...
Application/DHAC-RSS instproc recvNEGATIVECONFIRM {msg} {
  #do nothing about it
}
...
Application/DHAC-RSS instproc mergeMinimumCluster {} {
...
Application/DHAC-RSS instproc sendMERGE_REQ {distance} {
  global chan ns_ opt node_
...
Application/DHAC-RSS instproc recvMERGE_REQ {msg sender} {
  global ns_ cluster
...
Application/DHAC-RSS instproc ClusterMaintain {} {
...
Application/DHAC-RSS instproc createSchedule {} {
...
Application/DHAC-RSS instproc sendSCHEDULE {distance} {
  global ns_ opt node_
...
Application/DHAC-RSS instproc recvSCHEDULE {order sender} {
  global ns_ opt
...
Application/DHAC-RSS instproc StartBackupCH {} {
...
Application/DHAC-RSS instproc ReAssign {currentCH nodeID} {
...
Application/DHAC-RSS instproc AutoChange {currentCH nodeID} {
  global chan ns_ opt node_ cluster
...
Application/DHAC-RSS instproc CHECK_ENERGY_LEVEL {currentCH} {
...
Application/DHAC-RSS instproc collectionDATA {order} {
...
Application/DHAC-RSS instproc sendDATA {} {
...
Application/DHAC-RSS instproc recvDATA {msg} {
...
Application/DHAC-RSS instproc SendDataToBS {} {
...
Application/DHAC-RSS instproc SendMyDataToBS {nodeID} {
...
# Receiving Functions
############################################################################
Application/DHAC-RSS instproc recv {args} {
...
# Sending Functions
############################################################################
Application/DHAC-RSS instproc send {mac_dst link_dst type msg
                                      data_size dist code} {
  global ns_
  $self instvar rng_
...
Application/DHAC-RSS instproc send_now {mac_dst link_dst type msg \
                                          data_size dist code} {
...
Application/DHAC-RSS instproc getRandomNumber {llim ulim} {
  $self instvar rng_
  return [$rng_ uniform $llim $ulim]
}

Application/DHAC-RSS instproc node {} {
  return [[$self agent] set node_]
}

Application/DHAC-RSS instproc nodeID {} {
  return [[$self node] id]
}

Application/DHAC-RSS instproc mac {} {
  return [[$self node] set mac_(0)]
}

Application/DHAC-RSS instproc getX {} {
  return [[$self node] set X_]
}

Application/DHAC-RSS instproc getY {} {
  return [[$self node] set Y_]
}

Application/DHAC-RSS instproc getER {} {
  set er [[$self node] getER]
  return $er
}

Application/DHAC-RSS instproc setCode code {
  $self instvar code_
  set code_ $code
  [$self mac] set code_ $code
}

Application/DHAC-RSS instproc GoToSleep {} {
  global opt ns_
...
Application/DHAC-RSS instproc WakeUp {} {
  global opt ns_
  $self instvar begin_idle_ begin_sleep_
...
Application/DHAC-RSS instproc checkAlive {} {
...
Application/DHAC-RSS instproc isClusterHead? {nodeID} {
  global CHsign

  return [lindex $CHsign($nodeID) 0]
}

Application/DHAC-RSS instproc getCurrentCH {nodeID} {
  global CHsign

  return [lindex $CHsign($nodeID) 1]
}

Application/DHAC-RSS instproc setClusterHead {nodeID} {
  global CHsign

  set CHsign($nodeID) [list 1 $nodeID]
}

Application/DHAC-RSS instproc unsetClusterHead {nodeID currentCH} {
  global CHsign
...
Application/DHAC-RSS instproc ChangeCH {nodeID currentCH} {
  global CHsign

  set CHsign($nodeID) [list 0 $currentCH]
}

Application/DHAC-RSS instproc RemoveMember {memberlist nodeID} {
