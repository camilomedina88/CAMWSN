...
# Define options
# ======================================================================
source phyrate-default_options.tcl
...
set val(temp)           [lindex $argv 5]
set val(dataRate)       $val(temp)Mb
set val(basicRate)      [expr $val(temp)/9]Mb
set val(CBRrate)        [expr $val(temp)/$val(nn)]Mb
...
#    $ns_ flush-trace
    ...
    set f_throughput [open "phyrate-afr_throughput.txt" "a"]
    set f_a_delay [open "phyrate-afr_average_delay.txt" "a"]
    set f_p_delay [open "phyrate-afr_peak_delay.txt" "a"]
    set f_fairness [open "phyrate-afr_fairness.txt" "a"]
