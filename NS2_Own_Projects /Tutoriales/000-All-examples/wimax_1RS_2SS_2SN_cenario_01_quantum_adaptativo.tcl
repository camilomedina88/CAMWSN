...
for {set i 0} {$i < $nb_rs} {incr i} {
  ...
  [$rstation_($i) set mac_(0)] add-ms-period-diuc 30.0 40.0 2 7    ;# start; end; MS address; DIUC
  [$rstation_($i) set mac_(0)] add-ms-period-diuc 40.0 50.0 2 2
  [$rstation_($i) set mac_(0)] add-ms-period-diuc 50.0 60.0 2 1
  [$rstation_($i) set mac_(0)] add-ms-period-diuc 60.0 70.0 2 2
  [$rstation_($i) set mac_(0)] add-ms-period-diuc 80.0 90.0 2 7
