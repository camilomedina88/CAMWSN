...
# Open file for trace
set tf [open $output_dir/wimax_1RS_2SS_2SN_cenario_01c.tr w]
$ns trace-all $tf
...
#[$bstation set mac_(0)] set-servicehandler [new ServiceFlowHandler] ;# EINAR
...
#  [$rstation_($i) set mac_(0)] set-servicehandler [new ServiceFlowHandler] ;# EINAR
