...
WimaxScheduler/BS set quantum_ 850
WimaxScheduler/RS set quantum_ 850
WimaxScheduler/SS set quantum_ 850
...
# Open file for trace
set tf [open $output_dir/wimax_1RS_2SS_2SN_mod_07.tr w]
$ns trace-all $tf
#puts "Output file configured"

# Open file for recording throughput
set throughput_rv_ [open $output_dir/throughput_mod_07.tr w]
...
for {set i 0} {$i < $nb_mn} {incr i} {
  ...
  $vbr_($i) set rate_ 1000Kb ;# corresponds to interval of 3.75ms
