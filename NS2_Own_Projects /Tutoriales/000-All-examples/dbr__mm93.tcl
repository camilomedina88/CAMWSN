#    http://network-simulator-ns-2.7690.n7.nabble.com/dbr-routing-protocol-td29071.html
...
set opt(tr) "DBR1.tr" ;# trace file
set opt(datafile) "DBR1.data"
set opt(nam)            "DBR1.nam"  ;# nam file
...
#$a_($total_number) attach-DBR $opt(width)
