...
proc create_node { x y z } {
	...
	Mac/802_11 DSSS_AirPropagationTime 0.000035
	Mac/802_11 DSSS_AirPropagationConst 1
...
set cbr [create_cbr_connection $node_(1) $node_(2) 1.0 0.002 1500]
#
