...
# network testing of an application agent.  Once the sensor node detects phenom,
# it will send one alert to the gateway node via a UDP transport agent.
#
################################################################################
...
set tracefd [open phenom07.tr w]
$ns_ trace-all $tracefd

set namtrace [open phenom07.nam w]
...
#this line may be the source of the following warning:
#  MAC_802_11: accessing MAC cache_ array out of range (src 3, dst 1, size 2)!
