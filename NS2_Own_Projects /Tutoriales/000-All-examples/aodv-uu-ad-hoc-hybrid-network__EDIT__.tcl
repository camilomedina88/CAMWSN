# http://abdusyarif.wordpress.com/2011/03/27/tcl-script-aodv-uu-ad-hoc-hybrid-network/#more-334
# http://abdusyarif.wordpress.com/
...
$ns node-config -adhocRouting $val(adhocRP) -llType $val(ll) \
-macType $val(mac) \
-ifqType $val(ifq) \
# -ifqLen $val(ifqlen) \
-antType $val(ant) \
